...
# from firstapp.serializers import UserSerializer, GroupSerializer , ItemSerializer \
...
# from firstapp.models import CharityRegistration , UserRegistration , Item
